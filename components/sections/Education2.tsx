										...
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">UET Lahore</span>
											...
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2020-2022:</p>
													<div>
														<span className="text-primary-2">Government College University Lahore</span>
														<p className="text-dark">Intermediate Pre-Engineering</p>
													</div>
												</div>
											</li>
											{/* <li className="position-relative z-1 mb-3">
									...
									<ul className="ps-3">
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Diabetes Type Prediction with TabNet</span>
													<p className="text-dark">Developed a deep learning model achieving 88.5% accuracy for early diabetes prediction, with SHAP-based explainability.</p>
												</div>
											</div>
										</li>
										{/* <li className="position-relative z-1 mb-3">
